            ...
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    ...
                    echo "<button type='button' class='btn btn-sm btn-danger' data-bs-dismiss='modal'><i class='fa-solid fa-x'></i> Cancel</button>
                        <a href='deanApprove.php?edit=$id&landing=$landing&user=$dean_asst_name' class='btn btn-sm my-1 d-block btn-success' data-toggle='tooltip' data-placement='top' title='Approve'><i class='fa-solid fa-check'></i> Yes</a>
                     </div>
                </div>
            </div>
        </div>
        ...
        <div class='modal-dialog modal-md'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    ...
                    echo "<button type='button' class='btn btn-sm btn-danger' data-bs-dismiss='modal'><i class='fa-solid fa-x'></i> Cancel</button>
                        <a href='libraryApprove.php?edit=$id&landing=$landing&user=$libr_asst_name' class='btn btn-sm my-1 d-block btn-success' data-toggle='tooltip' data-placement='top' title='Approve'><i class='fa-solid fa-check'></i> Yes</a>
                     </div>
                </div>
            </div>
        </div>
