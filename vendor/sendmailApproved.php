...
function sendmailApproved($email, $lname, $fname, $mname, $tn, $type){
  ...
  $body ="
            ...
            <p>You may also download your signed Library Clearance form by clicking this <a href=https://ceumnlregistrar.com/ecle/formDownloadL.php?referenceID=$tn&type=$type> LINK </a>.</p>
