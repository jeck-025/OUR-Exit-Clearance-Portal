...
class chartForm extends config{
    public function filterForm(){
        echo "<div class='col-md p-3 form'>";
        echo "<div class='row'>";
        echo "<div class='col col-md-3 pb-5 ml-3'>";
        echo "<a class='btn btn-info btn-sm statSwitch' href='registrar2.php'> <i class='fa-solid fa-graduation-cap'></i>  Switch to Graduate Statistics</a>";
        echo "</div></div>";
        echo "<h3 class='col-md pb-3' style='text-align:center; font-weight:bold;'>"; 
        echo "Undergraduate Statistics</h3>";
        ...
        echo "<a class='btn btn-danger btn-sm' href='registrar.php'> Reset </a>";
        echo "</div>";
        echo "</form>";
        echo "</div></div>";
    }

    public function filterFormGD(){
        echo "<div class='col-md p-3 form'>";
        echo "<div class='row'>";
        echo "<div class='col col-md-3 pb-5 ml-3'>";
        echo "<a class='btn btn-info btn-sm statSwitch' href='registrar.php'><i class='fa-solid fa-school'></i>  Switch to Undergraduate Statistics</a>";
        echo "</div></div>";
        echo "<h3 class='col-md pb-3' style='text-align:center; font-weight:bold;'>"; 
        echo "Graduate Statistics</h3>";
        ...
        echo "<div class='col col-md-7'>";
            if(!empty($_GET['semester'])){
                ...
                echo "Change School Year and Semester to Display";
            }
            else{
                echo "Please choose School Year and Semester to Display";
            }
        echo "<form action='' method='get' name='filterchart'>";
        echo "<div class='p-3'>";
        echo "<select id='sy' name='sy' class='selectpicker form-control form-control-sm mr-2' data-live-search='true' title='Select School Year' required>";
        ...
        // echo "</select>";
        echo "<button type='submit' class='btn btn-info btn-sm'>View </button>";
        echo "<a class='btn btn-danger btn-sm' href='registrar2.php'> Reset </a>";
        echo "</div>";
        echo "</form>";
        echo "</div>";
