...
class sendMail extends config{
    ...
    public function sendDeanSAM(){
        ...
        mailerSAM($countUGPending0, $countUGHold0, $countGDPending0, $countGDHold0, $abbr0);
    }

    public function sendDeanDENT(){
        $config = new config;
        $con = $config->con();
        ...
        mailerDENT($countUGPending1, $countUGHold1, $countGDPending1, $countGDHold1, $abbr1);
    }

    public function sendDeanELAMS(){
        $config = new config;
        $con = $config->con();
        ...
        mailerELAMS($countUGPending2, $countUGHold2, $countGDPending2, $countGDHold2, $abbr2);
    }

    public function sendDeanGRADSCH(){
        $config = new config;
        $con = $config->con();
        ...
        mailerGRADSCH($countUGPending3, $countUGHold3, $countGDPending3, $countGDHold3, $abbr3);
    }

    public function sendDeanMEDTECH(){
        $config = new config;
        $con = $config->con();
        ...
        mailerMEDTECH($countUGPending4, $countUGHold4, $countGDPending4, $countGDHold4, $abbr4);
    }

    public function sendDeanMEDICINE(){
        $config = new config;
        $con = $config->con();
        ...
        mailerMEDICINE($countUGPending5, $countUGHold5, $countGDPending5, $countGDHold5, $abbr5);
    }

    public function sendDeanNURSING(){
        $config = new config;
        $con = $config->con();
        $abbr6 = 'NURSING';
        ...
        mailerNURSING($countUGPending6, $countUGHold6, $countGDPending6, $countGDHold6, $abbr6);
    }

    public function sendDeanNHM(){
        $config = new config;
        $con = $config->con();
        ...
        mailerNHM($countUGPending7, $countUGHold7, $countGDPending7, $countGDHold7, $abbr7);
    }

    public function sendDeanOPTO(){
        ...
        mailerOPTO($countUGPending8, $countUGHold8, $countGDPending8, $countGDHold8, $abbr8);
    }

    public function sendDeanPHARM(){
        $config = new config;
        $con = $config->con();
        ...
        mailerPHARM($countUGPending9, $countUGHold9, $countGDPending9, $countGDHold9, $abbr9);
    }

    public function sendDeanSCITECH(){
        $config = new config;
        $con = $config->con();
        ...
        mailerSCITECH($countUGPending10, $countUGHold10, $countGDPending10, $countGDHold10, $abbr10);
    }
