        ...
        <div class="bg-white" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush my-3">
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="guid-app-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
              </div>
            </div>
            ...
            <div class="item pb-3 border-bottom">
              ...
              <div class="sub-menu">
                <a href="guid-hld-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
              </div>
            </div>
