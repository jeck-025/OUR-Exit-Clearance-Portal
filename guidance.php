      ...
      <div class="d-flex" id="wrapper">
        <div class="bg-white" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush my-3">
            ...
            .$viewtable->viewTotalGuidance(). '</span>';  ?>
            </a>
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="guid-app-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer"><small>Exit Interview</small></a>
              </div>
            </div>
            ...
            <div class="item pb-3 border-bottom">
              ...
              <div class="sub-menu">
                <a href="guid-hld-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer"><small>Exit Interview</small></a>
              </div>
            </div>
              ...
              <ul class="navbar-nav  ms-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <!-- <li><a href="changepasswordGuidance.php" class="dropdown-item">Setting</a></li> -->
